...
Read the TODO.md inside the root folder.
**IMPORTANT** If no TODO.md exists, warn the user that the `plan-feature` workflow must be executed first and exit the conversation
